...
Roles can be loaded from static configuration files with the `role` section. Scopes are assigned by id.
...
> Have a look at [configuration files](/docs/provider-configuration/configuration-files#role)
